...
/* @fn spvReflectGetDescriptorBindingByName

 @param  p_module  Pointer to an instance of SpvReflectDescriptorBinding.
 @param  name      The name of the requested descriptor binding.
                   A name of NULL will return NULL.
                   A name of "" will always return NULL with
 ...
 @param  p_result  If successful, SPV_REFLECT_RESULT_SUCCESS will be
                   ...
                   here.
 @return           If the module contains a descriptor binding that
                   matches the provided name, a pointer to that binding
                   is returned. The caller must not free this pointer.
                   If no match can be found, or if an unrelated error
                   occurs, the return value will be NULL. Detailed
                   error results are written to *pResult.
