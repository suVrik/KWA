...
struct AntialiasingRenderPassDescriptor {
    Render* render;
    MemoryResource* transient_memory_resource;
};

class AntialiasingRenderPass : public FullScreenQuadRenderPass {
public:
    explicit AntialiasingRenderPass(const AntialiasingRenderPassDescriptor& descriptor);
