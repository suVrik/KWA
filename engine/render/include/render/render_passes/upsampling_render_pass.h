...
struct UpsamplingRenderPassDescriptor {
    Render* render;
    ...
    // Input attachment scale is meant to be twice as small.
...
class UpsamplingRenderPass : public FullScreenQuadRenderPass {
public:
    explicit UpsamplingRenderPass(const UpsamplingRenderPassDescriptor& descriptor);
